...
export default function Home() {
  return (
    <main className='w-[90%] desktop:w-[80%] mx-auto'>
      <header className='flex justify-between items-center w-full h-[70px] mb-10 border-b-1 border-black desktop:mb-5'>
      ...
      <div className='desktop:mt-4'>
        <div className='absolute right-[-100px] top-[-100px] desktop:inline mobile:hidden'>
          <Image
